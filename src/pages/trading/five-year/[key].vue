...
const key = useRoute('/trading/five-year/[key]').params.key
      ...
      <div h170 overflow-y-scroll bg-trading>
        ...
        <section>
          ...
          <div flex="~" mt3 justify-between px4 text-sm>
            <div class="bg-#CBBCFB" flex="~" h8 w13 items-center justify-center rounded-xl @click="go('day')">
              1D
            </div>
            ...
            <div class="bg-#7751f1" flex="~" h8 w13 items-center justify-center rounded-xl @click="go('five-year')">
              5Y
            </div>
          </div>
